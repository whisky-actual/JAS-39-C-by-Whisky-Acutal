...
--				=== INFRARED AIR TO AIR MISSILES ===
				...
				{ CLSID = "JF39_AIM-9L", attach_point_position = {0.1, 0.0, 0.0}, arg_increment = 0.0 }, -- AIM-9L
				{ CLSID = "JF39_A-DARTER", attach_point_position = {-0.45, -0.025, 0.0}, arg_increment = 0.0 }, -- A-Darter
				{ CLSID = "JF39_AIM-9M", attach_point_position = {0.1, 0.0, 0.0}, arg_increment = 0.0 }, -- AIM-9M
				{ CLSID = "JF39_AIM-9X", attach_point_position = {0.1, 0.0, 0.0}, arg_increment = 0.0 }, -- AIM-9X	
				{ CLSID = "JF39_PYTHON-5", attach_point_position = {-0.1, -0.12, 0.0}, arg_increment = 0.0 }, -- Python-5		
				{ CLSID = "JF39_ASRAAM", attach_point_position = {0.1, -0.10, 0.0}, arg_increment = 0.0 }, -- AIM-132 ASRAAM	
...
--				=== BVR AIR TO AIR MISSILES ===
				{ CLSID = "DIS_SD-10", attach_point_position = {0.4, -0.12, 0.0}, arg_value = 0.2 }, -- Meteor
--				{ CLSID = "DIS_SD-10_DUAL_L", arg_value = 0.2, forbidden = {{station = 3, loadout = {"DIS_BRM1_90"}}, {station = 3, loadout = {"DIS_TANK1100"}}} }, -- Meteor x 2
...
--				=== Air to ground missiles ===
                { CLSID = "DIS_C-701T", arg_value = 0.1 , attach_point_position = {0.37, -0.3, 0.0} }, -- AGM-65K
				{ CLSID = "DIS_C-701IR", arg_value = 0.1 , attach_point_position = {0.37, -0.3, 0.0} }, -- AGM-65G				
...
--				=== Guided rockets ===
				{ CLSID = "DIS_BRM1_90", attach_point_position = {-0.15, 0.02, 0.0}, arg_value = 0.5, forbidden = {{station = 3, loadout = {"DIS_BRM1_90"}}} }, -- Brimstone
...
--				=== Remove pylon ===		
        ...
        pylon(4, 0, -0.300, -0.336, 2.85,
            ...
            {
--              === BVR AIR TO AIR MISSILES ===
--				{ CLSID = "DIS_SD-10_DUAL_L", arg_value = 0.2 }, -- Meteor x 2				

--				=== Air to ground missiles ===
                { CLSID = "DIS_LS_6_500", arg_value = 0.5, Type = 1 }, -- AGM-154C				
				{ CLSID = "DIS_GB6_HE", arg_value = 0.5, Type = 1 }, -- BK90 MJ2
				{ CLSID = "DIS_GB6", attach_point_position = {-0.2, 0.025, 0.0}, arg_value = 0.5, Type = 1 }, -- Storm Shadow
				{ CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, arg_value = 0.5, Type = 1 }, -- GBU-31
...
--				=== Guided bombs ===
				...
				{ CLSID = "DIS_GBU_16", arg_value = 0.5 }, -- GBU-16
				{ CLSID = "DIS_GBU_10", arg_value = 0.5 }, -- GBU-10
				{ CLSID = "DIS_GBU_12_DUAL", arg_value = 0.5 }, -- GBU-12 x2
				{ CLSID = "DIS_LS_6_500", arg_increment = 0.5, Type = 1}, -- GBU-39 SDB TV Guided	
...
--				=== Unguided bombs ===
				...
				{ CLSID = "{AB8B8299-F1CC-4359-89B5-2172E0CF4A5A}", arg_value = 0.5 }, -- Mk-84
				{ CLSID = "{BRU33_2X_MK-82}", arg_value = 0.5 }, -- Mk-82 x 2
				{ CLSID = "{M71BOMB}", attach_point_position = {-0.50, 0.0, 0.0}, arg_value = 0.5 }, -- M71 x 4
...
--				=== Air to ground missiles ===
				...
				{ CLSID = "DIS_GB6_HE", arg_value = 0.5, Type = 1 }, -- BK90 MJ2									
				{ CLSID = "DIS_LS_6_500", arg_value = 0.5, Type = 1 }, -- AGM-154C
				{ CLSID = "DIS_GB6_TSP", attach_point_position = {0.0, 0.0, 0.0}, rg_value = 0.5, Type = 1 }, -- GBU-31
...
--				=== Drop tanks ===
                { CLSID = "DIS_TANK800", arg_value = 0.1 }, -- External drop tank 1100 litre				
				{ CLSID = "DIS_TANK1100", arg_value = 0.1, forbidden = {{station = 6, loadout = {"DIS_SD-10_DUAL_R"}}} }, -- External drop tank 1700 litre
...
--				=== Guided rockets ===
				{ CLSID = "DIS_BRM1_90", attach_point_position = {-0.15, 0.02, 0.0}, arg_value = 0.5, forbidden = {{station = 6, loadout = {"DIS_BRM1_90"}}, {station = 6, loadout = {"DIS_SD-10_DUAL_R"}}} }, -- Brimstone
...
--				=== Air to ground missiles ===
                { CLSID = "DIS_C-701T", arg_value = 0.1 , attach_point_position = {0.37, -0.30, 0.0} }, -- AGM-65K
				{ CLSID = "DIS_C-701IR", arg_value = 0.1 , attach_point_position = {0.37, -0.30, 0.0} }, -- AGM-65G
				{ CLSID = "DIS_GB6_HE", arg_value = 0.5, Type = 1 }, -- BK90 MJ2									
				{ CLSID = "DIS_LS_6_500", arg_value = 0.5, Type = 1 }, -- AGM-154C
...
--				=== Guided rockets ===
				{ CLSID = "DIS_BRM1_90", attach_point_position = {-0.15, 0.02, 0.0}, arg_value = 0.5, forbidden = {{station = 5, loadout = {"DIS_BRM1_90"}}} }, -- Brimstone
