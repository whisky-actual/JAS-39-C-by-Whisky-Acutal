...
local function clsid_c701t(use_ed)
    if use_ed then
        return "weapons.missiles.C_701T"
    else
        return "weapons.missiles.C-701T"
    end
end
local function clsid_c701ir(use_ed)
    if use_ed then
        --return "weapons.missiles.C_701IR"
        return "weapons.missiles.C-701IR"
    else
        return "weapons.missiles.C-701IR"
    end
end
...
declare_loadout({
    ...
    attribute        = clsid_c701t(use_ed_wpn),
    Count            = 1,
    Cx_pil           = 0.0006265625,
    Picture          = "c701t.png",
...
declare_loadout({
    ...
    attribute        = clsid_c701ir(use_ed_wpn),
    Count            = 1,
    Cx_pil           = 0.0006265625,
    Picture          = "c701t.png",
