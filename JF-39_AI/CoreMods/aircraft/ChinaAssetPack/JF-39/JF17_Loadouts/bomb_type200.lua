...
local function clsid_type_200(use_ed)
    if use_ed then
        return "weapons.bombs.Type_200A"
    else
        return "weapons.bombs.TYPE-200A"
    end
end
...
declare_loadout({
    ...
    attribute        = clsid_type_200(use_ed_wpn),
    Count            = 1,
    Cx_pil           = Type200.Cx,
...
declare_loadout({
    ...
    wsTypeOfWeapon   = clsid_type_200(use_ed_wpn),
