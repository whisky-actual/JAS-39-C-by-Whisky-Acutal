...
-- BRU_33A dual mk82 left/right
JF17_MK_82_DUAL_L = {
    category    = CAT_BOMBS,
    CLSID       = "DIS_MK_82_DUAL_GDJ_II19_L",
    Picture     = "mk82.png",
    displayName = _("BRU_33A - 2 x Mk-82"),
    Count       = 2,
    Weight      = 79 + 2 * 241,
...
-- BRU_33A dual mk82snakeeye left/right
JF17_MK_82S_DUAL_L = {
    category    = CAT_BOMBS,
    CLSID       = "DIS_MK_82S_DUAL_GDJ_II19_L",
    Picture     = "mk82AIR.png",
    displayName = _("BRU_33A - 2 x Mk-82 SnakeEye"),
    Count       = 2,
    Weight      = 79 + 2 * 232,
...
-- BRU_33A dual mk20 left/right
JF17_MK_20_DUAL_L = {
    category    = CAT_BOMBS,
    CLSID       = "DIS_MK_20_DUAL_GDJ_II19_L",
    Picture     = "Mk20.png",
    displayName = _("BRU_33A - 2 x Mk-20"),
    Count       = 2,
    Weight      = 79 + 2 * 222,
...
-- BRU_33A dual gbu12 left/right
JF17_GBU_12_DUAL_L = {
    category    = CAT_BOMBS,
    CLSID       = "DIS_GBU_12_DUAL_GDJ_II19_L",
    Picture     = "GBU12.png",
    displayName = _("BRU_33A - 2 x GBU-12"),
    Count       = 2,
    Weight      = 79 + 2 * 275,
    Cx_pil      = 0.000413 * 2 + 0.00122,
