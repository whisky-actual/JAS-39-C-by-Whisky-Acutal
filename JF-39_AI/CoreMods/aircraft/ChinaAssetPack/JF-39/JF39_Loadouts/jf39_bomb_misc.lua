...
JF17_MK_20 = {
    ...
    CLSID       = "DIS_MK_20",
    Picture     = "Mk20.png",
    displayName = _("Mk-20 Rockeye - 490lbs CBU, 247 x HEAT Bomblets"),
    Count       = 1,
    Weight      = 222,
    Cx_pil      = 0.000413,
...
JF17_GBU_10 = {
    ...
    CLSID       = "DIS_GBU_10",
    Picture     = "GBU10.png",
    displayName = _("GBU-10 - 2000lb Laser Guided Bomb"),
    Count       = 1,
    Weight      = 1162,
    Cx_pil      = 0.000793,
...
JF17_GBU_16 = {
    ...
    CLSID       = "DIS_GBU_16",
    Picture     = "GBU16.png",
    displayName = _("GBU-16 - 1000lb Laser Guided Bomb"),
    Count       = 1,
    Weight      = 564,
    Cx_pil      = 0.000413,
...
JF17_GBU_12 = {
    ...
    CLSID       = "DIS_GBU_12",
    Picture     = "GBU12.png",
    displayName = _("GBU-12 - 500lb Laser Guided Bomb"),
    Count       = 1,
    Weight      = 275,
    Cx_pil      = 0.000413,
...
JF17_MK_82_DUAL_L = {
    ...
    Picture     = "mk82.png",
    displayName = _("Mk-82 - 500lb GP Bomb LD x2"),
    Count       = 2,
    Weight      = 79 + 2 * 241,
...
JF17_MK_82_DUAL_R.settings  = {}
JF17_MK_82_DUAL_R.settings  = Get_Combined_GUISettings_Preset("MDRN_B_A_GPLD")
...
JF17_MK_82S_DUAL_L = {
    ...
    Picture     = "mk82AIR.png",
    displayName = _("Mk-82 Snakeye - 500lb GP Bomb HD x2"),
    Count       = 2,
    Weight      = 79 + 2 * 232,
...
JF17_MK_82S_DUAL_R.attribute = {4, 5, 32, WSTYPE_PLACEHOLDER}
JF17_MK_82S_DUAL_R.settings  = {}
JF17_MK_82S_DUAL_R.settings  = Get_Combined_GUISettings_Preset("MDRN_B_A_GPLD")
...
JF17_MK_20_DUAL_L = {
    ...
    Picture     = "Mk20.png",
    displayName = _("Mk-20 Rockeye - 490lbs CBU, 247 x HEAT Bomblets x2"),
    Count       = 2,
    Weight      = 79 + 2 * 222,
...
JF17_MK_20_DUAL_R.settings  = {}
JF17_MK_20_DUAL_R.settings  = Get_Fuze_GUISettings_Preset("MDRN_CC_A_Mk20")
...
JF17_GBU_12_DUAL_L = {
    ...
    Picture     = "GBU12.png",
    displayName = _("GBU-12 - 500lb Laser Guided Bomb x2"),
    Count       = 2,
    Weight      = 79 + 2 * 275,
    Cx_pil      = 0.000413 * 2 + 0.00122,
	Cx_item     = 0.000413,
...
JF17_GBU_12_DUAL_R.settings  = {}
JF17_GBU_12_DUAL_R.settings  = Get_Combined_GUISettings_Preset("Paveway_II")
...
--[[
local fuze_set_ld  = CombineFuzeGUISettings({ "M905", "FMU139CB_LD", "FMU152AB_LD", "M904E4", "DSU33" })
local fuze_data_ld = CreateCombinedPreset({ fuze_set_ld })

local fuze_set_hd  = CombineFuzeGUISettings({ "M905", "FMU139CB_HD", "FMU152AB_HD", "M904E4", "DSU33" })
local fuze_data_hd = CreateCombinedPreset({ fuze_set_hd })
]]
...
declare_loadout(
{
    ...
    ejectVelocity   = eject_speed_bomb,
    ejectDirection  = {0, -1, 0},
	--settings        = fuze_data_hd, -- Get_Combined_GUISettings_Preset("MDRN_B_A_GPLD")
}
)
...
declare_loadout(
{
    ...
    ejectVelocity   = eject_speed_bomb,
    ejectDirection  = {0, -1, 0},
	--settings        = fuze_data_ld, -- Get_Combined_GUISettings_Preset("MDRN_B_A_GPLD")
}
)
