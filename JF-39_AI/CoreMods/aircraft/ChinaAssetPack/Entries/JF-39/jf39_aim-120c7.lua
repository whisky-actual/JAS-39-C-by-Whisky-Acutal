...
declare_loadout({
	...
	declare_loadout({
		...
		Picture     = 'us_AIM-120C.png',
		wsTypeOfWeapon   = JAS_aim120c7_AA.wsTypeOfWeapon,
		displayName = _('3 x ' ..jas_aim120c7_name),
		attribute	=	{4,	4,	32,	WSTYPE_PLACEHOLDER},
		Count       = 3,
		Weight      = 3 * jas_aim120c7_mass + pylon_mass,
	   Elements = { {
				IsAdapter = true,
				ShapeName = "TER-9A"
			}, {
...
declare_loadout({
    ...
    wsTypeOfWeapon = JAS_aim120c7_AA.wsTypeOfWeapon,
    attribute      = {4,4,32,WSTYPE_PLACEHOLDER},
    displayName    = _('2 x ' ..jas_aim120c7_name),
    Cx_pil         = 0.000859765625 * 1.31,
    Count          = 2,
    Weight         = 2 * jas_aim120c7_mass + pylon_mass,
    Elements       = {
        { ShapeName = 'LAU-115C+2_LAU127', IsAdapter = true, },
        { ShapeName = 'aim-120c',            connector_name = 'Point02'},
        { ShapeName = 'aim-120c',            connector_name = 'Point03'},
