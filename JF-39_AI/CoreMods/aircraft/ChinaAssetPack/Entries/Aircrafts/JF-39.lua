...
--				=== BVR AIR TO AIR MISSILES ===
				{ CLSID = "DIS_PL-12" ,arg_increment = 0.0, attach_point_position = {0.30, -0.13, 0.0}},  -- Meteor x1
                { CLSID = "DIS_SD-10", attach_point_position = {0.0, -0.12, 0.0}, arg_value = 0.2 }, -- AIM-120C-7 x1
--              { CLSID = "DIS_SD-10_DUAL_L", arg_value = 0.2}, -- AIM-120C-7 x2
                { CLSID = "DIS_SD-10_DUAL_R", arg_value = 0.2}, -- AIM-120C-7 x3
...
--              === ROCKETS ===
                { CLSID = "DIS_BRM1_90", attach_point_position = {-0.15, 0.02, 0.0}, arg_value = 0.5 }, -- Brimstone (Guided Rocket)
...
--				{ CLSID = "{M71BOMB}", attach_point_position = {-0.70, 0.0, 0.0}, arg_value = 0.5 }, -- M71 x 4
				...
				{ CLSID = "DIS_TYPE200_DUAL_L", arg_value = 0.3 },
