...
dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_U1_RDR_Base.lua")

dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_U1_RDR_Render.lua")
...
dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_U1_RDR_AG_Contact.lua")
