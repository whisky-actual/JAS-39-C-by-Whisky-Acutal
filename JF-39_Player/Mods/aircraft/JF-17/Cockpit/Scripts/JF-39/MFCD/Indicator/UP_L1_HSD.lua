dofile(LockOn_Options.script_path .. "JF-39/MFCD/avMFCD.lua")
...
----[[ Nav ]]
dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_L1_HSD_NAV.lua")

----[[ TGT ]]
dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_L1_HSD_TGT.lua")

----[[ SA RWR/MAWS/DL/RDR ]]
dofile(LockOn_Options.script_path .. "JF-39/MFCD/Indicator/UP_L1_HSD_SA.lua")
