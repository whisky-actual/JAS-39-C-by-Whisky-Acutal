dofile(LockOn_Options.script_path.."JF-39/HUD/Indicator/HUD_def.lua")
-----------------------------------------
-- JF_39 HUD BASE
-----------------------------------------
local HUD_BASE 				= CreateElement "ceSimple"
HUD_BASE.name  				= create_guid_string()
HUD_BASE.init_pos			= {-0.08, 0, 1.5}	          
...
Left_Side_Indication_base.init_pos			= {-0.675, -0.2, -0.45}
...
local GS_Text       = add_text_hud("GS", -0.05, -0.1, Left_Side_Indication_base, "Gripen_Font_green")
local GS_Indicator  = add_text_hud_param(0.075, -0.1, "CURR_GS", "JF39_HUD", "%.0f", Left_Side_Indication_base, HUD_strdefs_digit, "Gripen_Font_green")--2nd CURR_GS is the transparency parameter
-----------------------------------------
