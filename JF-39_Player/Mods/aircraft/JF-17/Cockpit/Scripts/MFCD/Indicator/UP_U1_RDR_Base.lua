...
SQUARE.controllers    	= {{"opacity_using_parameter", "check_power",0}}
--SQUARE.controllers     = {{'rdr_video_check', 0},}--{"check_map_filter", 0},
AddToUpper(SQUARE)

SQUARE_NIGHT                 = CreateElement "ceMeshPoly"
SQUARE_NIGHT.name            = "SQUARE_NIGHT"
SQUARE_NIGHT.init_pos        = {0, 0, 0}
SQUARE_NIGHT.vertices        = {{-rdr_frame_length_half,  rdr_frame_length_half},
                             { rdr_frame_length_half,  rdr_frame_length_half},
                             { rdr_frame_length_half, -rdr_frame_length_half},
                             {-rdr_frame_length_half, -rdr_frame_length_half}}
...
SQUARE_NIGHT.additive_alpha  = false
--SQUARE_NIGHT.element_params 	= {"JF39_MFCD"}
SQUARE_NIGHT.controllers    	= {{"check_power",0}}
--SQUARE_NIGHT.controllers     = {{'rdr_video_check', 0},}--{"check_map_filter", 0},
AddToUpper(SQUARE_NIGHT)
