...
HUD_HORIZON = MakeMaterial(HUD_IND_TEX_PATH.."JAS_HUD_Symbols", GREEN)
HUD_POSITIVE_PITCH = MakeMaterial(HUD_IND_TEX_PATH.."PitchLines", GREEN)
HUD_NEGATIVE_PITCH = MakeMaterial(HUD_IND_TEX_PATH.."PitchLinesNegative", GREEN)
HUD_HeadingScale = MakeMaterial(HUD_IND_TEX_PATH.."HUD_HeadingScale", GREEN)
...
function AddHudElement4(object)
    ...
    object.collimated       = true
	object.blend_mode 		=  blend_mode.IBM_REGULAR_ADDITIVE_ALPHA
	--parent.element_params 	= {"JF39_MFCD"}
