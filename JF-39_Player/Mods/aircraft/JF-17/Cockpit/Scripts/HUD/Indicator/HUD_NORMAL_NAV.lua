...
local texts ={
    {value="\\", alignment="LeftCenter",  formats={"%s"}, init_pos={-94, spd_bar_vert_bias}, ctrls={{"hud_fp_spd", 0.03},{"hud_check_declutter"}}},
    {value="/", alignment="RightCenter", formats={"%s"}, init_pos={ 85, alt_bar_vert_bias},  ctrls={{"hud_fp_alt", 0.03},{"hud_check_declutter"}} },
}
...
HW = (42.064/2)+15
HH = 23.857/2
SPD_BAR_SHIFT = -2 -- Adjust this value to shift all elements horizontally
