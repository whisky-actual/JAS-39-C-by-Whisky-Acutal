...
key_cmds = {
	...
	--
	Ext_Light_Formation_Inc = dcounter(),
	Ext_Light_Formation_Dec = dcounter(),
	
	Ext_Light_AntiCollision_Inc = dcounter(),
	Ext_Light_AntiCollision_Dec = dcounter(),
	
	ECS_Mode_Selector_Inc = dcounter(),
	ECS_Mode_Selector_Dec = dcounter(),
	
	INS_Mode_Selector_Inc = dcounter(),
	INS_Mode_Selector_Dec = dcounter(),
