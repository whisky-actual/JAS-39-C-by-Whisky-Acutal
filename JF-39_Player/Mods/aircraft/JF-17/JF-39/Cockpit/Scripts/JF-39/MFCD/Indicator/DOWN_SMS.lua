...
local textsDown = {
    ---- OSB
    {-- FCS
        init_pos = {x_bias, 0.25}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "ID.   BRG    RNG     DV    ALT",
    },
    {
        init_pos = {x_bias, 0.17}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "00   000L     0    1693    1000", ctrls = {{"clink_contact_threat_list", 0}},
    },
    {
        init_pos = {x_bias, 0.10}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "00   000L     0    1693    1000", ctrls = {{"clink_contact_threat_list", 1}},
    },
    {
        init_pos = {x_bias, 0.03}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "00   000L     0    1693    1000", ctrls = {{"clink_contact_threat_list", 2}},
    },
    {
        init_pos = {x_bias, -0.04}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "00   000L     0    1693    1000", ctrls = {{"clink_contact_threat_list", 3}},
    },
    {
        init_pos = {x_bias, -0.11}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
        value = "00   000L     0    1693    1000", ctrls = {{"clink_contact_threat_list", 4}},
    },
    {
        init_pos = {x_bias, -0.18}, alignment = "LeftCenter", stringdefs = MFCD_STRINGDEFS_DEF_X1,
