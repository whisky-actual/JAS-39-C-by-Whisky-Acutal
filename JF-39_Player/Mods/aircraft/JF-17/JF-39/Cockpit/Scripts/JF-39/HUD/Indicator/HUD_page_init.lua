...
page_subsets  = {
    [HUD_PAGE_BASE]    = script_path .. "JF-39/HUD/Indicator/HUD_BASE.lua",   -- 底层页面
    [HUD_PAGE_OFF]     = script_path .. "JF-39/HUD/Indicator/HUD_OFF.lua",    -- 关机页面
    [HUD_PAGE_NORMAL]  = script_path .. "JF-39/HUD/Indicator/HUD_NORMAL.lua", -- 正常显示
    [HUD_PAGE_GRID]    = script_path .. "JF-39/HUD/Indicator/HUD_GRID.lua",   -- 备用模式
}
