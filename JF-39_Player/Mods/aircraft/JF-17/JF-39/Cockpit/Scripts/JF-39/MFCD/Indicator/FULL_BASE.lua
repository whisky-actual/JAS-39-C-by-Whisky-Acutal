...
MFCD_base.controllers    	= {{"opacity_using_parameter",0}}
--MFCD_base.element_params    = {"HUD_BRIGHTNESS"}
--MFCD_base.controllers       = {{"parameter_in_range", 0, 0.05, 2.0} }-- Only show if brightness is ≥ 0.25
