...
cockpit_local_point         = {4.50, 0.625, 0.000}-- JF-39 Cockpit Position
--cockpit_local_point         = {4.62, 0.670, 0.000}-- JF-17 Cockpit Position
...
mirrors_data =
{
    center_point      = {0.20,0.025,0.00},  --{ 0.423, 0.115, 0.00 }, difference from cockpit_local_point {3.715, 0.29, 0.0},
    width             = math.rad(50), --0.265, --integrated (keep in mind that mirrors can be none planar )
    aspect            = 1.20,
    rotation          = math.rad(0);
    animation_speed   = 2.0;
    --near_clip         = 0.1;
